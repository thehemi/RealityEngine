...
/// Desc: 
//
/// Copyright (c) 1999-2001 Artificial Studios. All rights reserved.
//-----------------------------------------------------------------------------
#ifndef DSUTIL_H
#define DSUTIL_H
...
public:
	...
	friend class CSoundManager; /// a bit lame
	LPDIRECTSOUND m_pDS; /// Safe to keep this?

    HRESULT RestoreBuffer( LPDIRECTSOUNDBUFFER pDSB, BOOL* pbWasRestored );

public:
	CSound(){} /// For duplication
	...
	DWORD GetNumBuffers(){ return m_dwNumBuffers; }
...
public:
	...
	/// My reference counting system
	int numRefs;
	VOID Release(){ numRefs --; if(numRefs == 0) delete this; }
	VOID AddRef(){ numRefs++; }
};
