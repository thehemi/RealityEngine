...
public:
	...
	static bool DeserializeClassHeader(RakNet::BitStream *bitStream, int &action, ObjectID &objectId,char classIdentifier[MAXIMUM_CLASS_IDENTIFIER_LENGTH], bool &localObject, unsigned char &localObjectIndex);
...
protected:
	...
	bool localObject; // localObject means this object was created on the local system.  If false, it means it was created by the network
	unsigned char localObjectIdentifier; // If this is a local object, this identifies it uniquely
	bool distributedMemoryInitialized; // This records if the distributed memory was initialized via DistributedMemoryInit
	PlayerID clientOwnerID; // Which client is allowed to change the client authoritative members of this object
