...
void	*operator new(size_t reportedSize)
{
	...
	for(;;)
	{
		...
		void	*ptr = m_allocator(sourceFile, sourceLine, sourceFunc, 
			m_alloc_new, reportedSize);
...
void	*operator new[](size_t reportedSize)
{
	...
	for(;;)
	{
		...
		void	*ptr = m_allocator(sourceFile, sourceLine, sourceFunc, 
			m_alloc_new_array, reportedSize);
...
void	*operator new[](size_t reportedSize, const char *sourceFile, int sourceLine)
{
	...
	for(;;)
	{
		...
		void	*ptr = m_allocator(sourceFile, sourceLine, "??", m_alloc_new_array, 
			reportedSize);
