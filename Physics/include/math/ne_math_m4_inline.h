...
{
    M[0][0] = V.n.X; M[1][1] = V.n.Y; M[2][2] = V.n.Z;
}
...
{
    M[0][0] = V1.n.X;  M[1][0] = V1.n.Y;  M[2][0] = V1.n.Z;
    M[0][1] = V2.n.X;  M[1][1] = V2.n.Y;  M[2][1] = V2.n.Z;
    M[0][2] = V3.n.X;  M[1][2] = V3.n.Y;  M[2][2] = V3.n.Z;
}
...
{
	neV3 tmp;
    return tmp.Set( M[0][0] * V.n.X + M[1][0] * V.n.Y + M[2][0] * V.n.Z,
                     M[0][1] * V.n.X + M[1][1] * V.n.Y + M[2][1] * V.n.Z,
                     M[0][2] * V.n.X + M[1][2] * V.n.Y + M[2][2] * V.n.Z );
}
...
{
	neV3 tmp;
    return tmp.Set( M.M[0][0] * V.n.X + M.M[1][0] * V.n.Y + M.M[2][0] * V.n.Z + M.M[3][0],
                     M.M[0][1] * V.n.X + M.M[1][1] * V.n.Y + M.M[2][1] * V.n.Z + M.M[3][1],
                     M.M[0][2] * V.n.X + M.M[1][2] * V.n.Y + M.M[2][2] * V.n.Z + M.M[3][2] );
}
...
NEINLINE neM4 neM4_BuildSkewSymmetric( const neV3& Vector )
{
    ...
    m.M[0][0] =  0;        m.M[0][1] =  Vector.n.Z; m.M[0][2] = -Vector.n.Y;
    m.M[1][0] = -Vector.n.Z; m.M[1][1] = 0;         m.M[1][2] =  Vector.n.X;
    m.M[2][0] =  Vector.n.Y; m.M[2][1] = -Vector.n.X; m.M[2][2] = 0;
