...
%MSVCDIR%\msdev\msdev.exe nv_math.dsp /CLEAN /MAKE "nv_math - Win32 Release Multithreaded DLL with PDB" /REBUILD /USEENV
%MSVCDIR%\msdev\msdev.exe nv_math.dsp /CLEAN /MAKE "nv_math - Win32 Debug Multithreaded DLL" /REBUILD /USEENV
