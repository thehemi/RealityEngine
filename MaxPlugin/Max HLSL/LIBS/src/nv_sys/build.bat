...
%MSVCDIR%\msdev\msdev.exe nv_sys.dsp /CLEAN /MAKE "nv_sys - Win32 Release Multithreaded DLL with PDB" /REBUILD /USEENV
%MSVCDIR%\msdev\msdev.exe nv_sys.dsp /CLEAN /MAKE "nv_sys - Win32 Debug Multithreaded DLL" /REBUILD /USEENV
