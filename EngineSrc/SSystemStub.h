...
typedef void ( *TSSystem_ActorTick)(int index);
...
typedef void ( *TSSystem_ActorGetName)(int index,char *&classname);
...
typedef void (*TSSystem_ControllerCallback)(int index,void * info);
...
typedef void  ( *TSSystem_ActorProcessInput)(int index);
typedef void  ( *TSSystem_ActorUpdateCamera)(int index);
...
//WORLD FUNCTIONS
//typedef void ( *TSSystem_WorldWrap)(void * world);
//typedef void ( *TSSystem_WorldDelete)(void * world);
...
extern TSSystem_ActorTick		SSystem_ActorTick;
...
extern TSSystem_ActorGetName    SSystem_ActorGetName;
...
extern TSSystem_ActorProcessInput SSystem_ActorProcessInput;
extern TSSystem_ActorUpdateCamera SSystem_ActorUpdateCamera;
...
extern TSSystem_ControllerCallback SSystem_ControllerCallback;
//extern TSSystem_WorldWrap       SSystem_WorldWrap;
//extern TSSystem_WorldDelete     SSystem_WorldDelete;
