...
//-----------------------------------------------------------------------------
/// \brief Interface needed by tree data to do its job
//
...
/// Enumerates the BSP leaves along a ray, box, etc
class ISpatialQuery
{
public:
...
public:
	...
	virtual bool _fastcall EnumerateElement( int userId, int context ) = 0;
};

/// Data associated with leaves in the BSP tree
class IBSPTreeData
{
public:
