...
HRESULT CStarDef::Initialize(const CStarDef& src)
{
	...
	_tcsncpy( m_strStarName, src.m_strStarName, 255 );
							 ...
							 bool bRotation)
{
	...
	_tcsncpy( m_strStarName, szStarName, 255 );
...
HRESULT CGlareDef::Initialize(const CGlareDef& src)
{
	...
	_tcsncpy( m_strGlareName, src.m_strGlareName, 255 );
							  ...
							  float fAfterimageLuminance)
{
	...
	// Create parameters
	_tcsncpy( m_strGlareName, szStarName, 255 );
